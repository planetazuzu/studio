...
import type { Cost, CostCategory, Course } from '@/lib/types';
import { costCategories } from '@/lib/data';
...
const costSchema = z.object({
    ...
    category: z.enum(costCategories as [string, ...string[]], { required_error: "Debes seleccionar una categoría."}),
